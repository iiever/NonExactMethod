...
public class NonExactSolution {
    ...
    public static void main(String[] args) {
       ...
       FileWriter writer;
            try{
                writer = new FileWriter("E:\\INTI (Degree)\\Theoretical Aspects Of Computer Science\\Non-ExactSolution-master\\time.txt" , true);
        ...
        FileWriter writer2;
        try{
            writer2 = new FileWriter("E:\\INTI (Degree)\\Theoretical Aspects Of Computer Science\\Non-ExactSolution-master\\cliqueResult.txt" , true);
    ...
    /**
     * Carry out Step 1 - 3 as shown below to determine if a clique exists
    ...
    public static int cliqueExists()
    {
        ...
        while (loop_counter < 100)
        {
            ...
            //System.out.println("This" +p.getKey());
